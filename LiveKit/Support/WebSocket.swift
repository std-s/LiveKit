...
internal class WebSocket: NSObject, URLSessionWebSocketDelegate, Loggable {
    ...
    private lazy var session: URLSession = {
        ...
        print("URLSessionConfiguration.timeoutIntervalForRequest: \(config.timeoutIntervalForRequest)")
        print("URLSessionConfiguration.timeoutIntervalForResource: \(config.timeoutIntervalForResource)")
