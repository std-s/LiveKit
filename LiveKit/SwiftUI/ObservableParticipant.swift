...
extension ObservableParticipant: ParticipantDelegate, Loggable {
    ...
    public func participant(_ participant: RemoteParticipant,
                            ...
                            track: Track) {
        print("\(self.hashValue) didSubscribe remoteTrack: \(String(describing: track.sid))")
    ...
    public func participant(_ participant: RemoteParticipant,
                            ...
                            track: Track) {
        print("\(self.hashValue) didUnsubscribe remoteTrack: \(String(describing: track.sid))")
        DispatchQueue.main.async {
            self.objectWillChange.send()
        }
    }
    ...
    public func participant(_ participant: RemoteParticipant,
        ...
        print("\(self.hashValue) didUpdate allowed: \(allowed)")
        DispatchQueue.main.async {
            self.objectWillChange.send()
        }
    }
    ...
    public func participant(_ participant: Participant,
                            ...
                            muted: Bool) {
        print("\(self.hashValue) didUpdate muted: \(muted)")
        DispatchQueue.main.async {
            self.objectWillChange.send()
        }
    }
